...
<head>
    ...
    <link rel="stylesheet" href="bootstrap files/bootstrap4.1.3/bootstrap.min.css">
    <style>
                            ...
                            <div class="flex -mx-3">
                                <div class="w-1/2 px-3 mb-5">
                                    ...
                                    <div class="flex">
                                        ...
                                        <input type="text" name="fname" required class="w-full -ml-10 pl-10 pr-3 py-2 rounded-lg border-2 border-gray-200 outline-none focus:border-indigo-500" placeholder="John">
                                    </div>
                                </div>
                                <div class="w-1/2 px-3 mb-5">
                                    ...
                                    <div class="flex">
                                        <div class="w-10 z-10 pl-1 text-center pointer-events-none flex items-center justify-center"><i class="mdi mdi-account-outline text-gray-400 text-lg"></i></div>
                                        <input name="lname" required type="text" class="w-full -ml-10 pl-10 pr-3 py-2 rounded-lg border-2 border-gray-200 outline-none focus:border-indigo-500" placeholder="Smith">
                                    </div>
                                </div>
                            </div>
                            <div class="flex -mx-3">
                            ...
                            <div class="flex -mx-3">
                                <div class="w-full px-3 mb-12">
                                    ...
                                    <div class="flex">
                                        ...
                                        <input name="password" required type="password" class="w-full -ml-10 pl-10 pr-3 py-2 rounded-lg border-2 border-gray-200 outline-none focus:border-indigo-500" placeholder="************">
                                    </div>
                                </div>
                            </div>
                            <div class="flex -mx-3">
                                <div class="w-full px-3 mb-5">
                                    <button type="submit" name="reg" class="block w-full max-w-xs mx-auto bg-indigo-500 hover:bg-indigo-700 focus:bg-indigo-700 text-white rounded-lg px-3 py-3 font-semibold bg-black">REGISTER NOW</button>
                                </div>
                            </div>
                            <h2 class=" m-4 justify-center text-center bg-red-200 mb-4 text-xl">or</h2>
                            <div class="flex -mx-3">
                                <div class="w-full px-3 mb-5">
                                    <a href="login.php" class="block w-full mx-auto text-white rounded-lg px-3 py-3 font-semibold bg-black text-center">Login</a>
                                </div>
                            </div>
                    </div>
                    </form>
